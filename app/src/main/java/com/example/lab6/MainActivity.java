...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyAdapter cubeeAdapter = new MyAdapter(cubeeData, R.layout.cubbe_list);
